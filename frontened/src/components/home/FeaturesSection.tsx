      ...
      <div className="container-custom">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 xs:gap-4 sm:gap-6 md:gap-8">
          {features.map((feature) => (
            <div
              key={feature.id}
              className="bg-white p-3 xs:p-4 sm:p-6 rounded-lg shadow-sm flex flex-col items-center text-center transition-transform hover:shadow-md hover:-translate-y-1"
            >
