      ...
      <div className="py-2 sm:py-4">
        <div className="container-custom flex items-center justify-between">
          ...
          <div className="hidden sm:flex flex-1 max-w-md mx-4 lg:mx-10">
            <div className="relative w-full">
              <Input
                ...
                className="w-full pr-10 border-gray-300 rounded-md focus-visible:ring-ekka-primary text-sm"
              />
              <Button
                variant="ghost"
                size="icon"
          ...
          <div className="flex items-center space-x-1 xs:space-x-2 sm:space-x-4">
            <Link href="/account" className="hidden md:flex items-center hover:text-ekka-primary transition-colors p-1.5">
              <User className="h-5 w-5 mr-1" />
              <span className="sr-only md:not-sr-only text-sm">Account</span>
            </Link>
            <Link href="/wishlist" className="flex items-center hover:text-ekka-primary transition-colors p-1.5">
              <div className="relative">
                <Heart className="h-5 w-5" />
                <span className="absolute -top-2 -right-2 bg-ekka-primary text-white text-xs rounded-full w-4 h-4 flex items-center justify-center">
                  0
                </span>
              </div>
              <span className="sr-only sm:not-sr-only sm:ml-1 text-sm hidden md:inline-block">Wishlist</span>
            </Link>
            <Link href="/cart" className="flex items-center hover:text-ekka-primary transition-colors p-1.5">
              <div className="relative">
              ...
              <SheetContent side="left" className="w-[85%] sm:w-[385px] p-0">
                ...
                <div className="p-4">
                  ...
                  <div className="space-y-1 mb-4">
                    ...
                    <Link href="/products" className="block py-2 hover:text-ekka-primary transition-colors text-sm font-medium">Products</Link>
                  </div>
      ...
      <div className="border-t hidden sm:block">
        <div className="container-custom">
          <nav className="flex flex-wrap space-x-4 sm:space-x-8">
            <Link href="/" className="py-2 sm:py-3 text-sm font-medium hover:text-ekka-primary transition-colors">
              Home
            </Link>
            <Link href="/shop" className="py-2 sm:py-3 text-sm font-medium hover:text-ekka-primary transition-colors">
              Shop
            </Link>
            <Link href="/categories" className="py-2 sm:py-3 text-sm font-medium hover:text-ekka-primary transition-colors">
              Categories
            </Link>
            <Link href="/products" className="py-2 sm:py-3 text-sm font-medium hover:text-ekka-primary transition-colors">
              Products
            </Link>
            <Link href="/about" className="py-2 sm:py-3 text-sm font-medium hover:text-ekka-primary transition-colors">
              About
            </Link>
            <Link href="/contact" className="py-2 sm:py-3 text-sm font-medium hover:text-ekka-primary transition-colors">
              Contact
            </Link>
          </nav>
        </div>
